window.$docsify = {
  name: "<a href='https://linea-analytics.com/' target='_blank' rel='noopener noreferrer'><img src='./images/logos/logo_white_cropped.png' width='150px' alt='Linea Analytics'></a><br><h6 class='sidebar-subheader'>Documentation</h6>",
